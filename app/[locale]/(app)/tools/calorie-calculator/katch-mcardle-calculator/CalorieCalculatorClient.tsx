      ...
      <div className="light:bg-white dark:bg-base-200/20 backdrop-blur-sm rounded-2xl border border-base-content/10 dark:border-base-content/5 p-2 sm:p-8 transition-all duration-300">
        <div className="space-y-6">
          ...
          <button
            ...
            className={
              "w-full py-4 px-6 rounded-xl bg-gradient-to-r from-[#FF5722] to-[#EF4444] text-white font-bold text-lg transition-all duration-300 hover:scale-[1.02] hover:shadow-lg hover:shadow-primary/25 active:scale-[0.98] touch-manipulation"
            }
