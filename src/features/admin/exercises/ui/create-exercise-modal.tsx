...
import { createExercise } from "@/features/admin/exercises/actions/create-exercise.action";
...
export function CreateExerciseModal({ open, onOpenChangeAction }: CreateExerciseModalProps) {
        ...
        <div className="modal modal-open">
          <div className="modal-box w-11/12 max-w-2xl">
            <div className="flex justify-between items-center mb-4">
              <h3 className="font-bold text-lg">Créer un exercice</h3>
